        ...
        <SwiperSlide>
          ...
          <figure className="clients">
            ...
            <figcaption>
              <h2>Eleanor Crisp</h2>
              <h4>UX Design</h4>
              <blockquote>The IoT solution provided by the team revolutionized our operations, enhancing efficiency and unlocking new possibilities for our business.!</blockquote>
            </figcaption>
          </figure>
        </SwiperSlide>
        <SwiperSlide>
