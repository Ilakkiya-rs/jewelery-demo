...
const About = () => {
    ...
    const profiles = [Picture, Picture,Pic,Pic]; 
    const names = ["Ilakkiya Shanmugam", "Vaishnavi", "Umang", "UB"];
    const statuses = ["Front-End Developer", "Developer", "CEO-BQTech", "CEO-USquare"];
    const abouts = [
